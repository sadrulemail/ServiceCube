<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLTE.master" AutoEventWireup="true" CodeFile="Call_Count.aspx.cs" Inherits="Call_Count" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="grdvComment" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Resolved" SortExpression="Resolved">
                        <ItemTemplate>
                            <%# Eval("Resolved") %>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:SqlDataSource ID="SqlDataSourceComments" runat="server" ConnectionString="<%$ ConnectionStrings:ServiceCubeConnectionString %>"
                SelectCommand="s_Call_Count" SelectCommandType="StoredProcedure" OnSelected="SqlDataSourceComments_Selected">
                <SelectParameters>
