<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLTE.master" AutoEventWireup="true"
    CodeFile="MyCreateTicket.aspx.cs" Inherits="MyCreateTicket" EnableEventValidation="false"
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div id="uploadDialog" title="Add Files" style="display: none;">
                <asp:AjaxFileUpload ID="AjaxFileUpload1" runat="server" ViewStateMode="Enabled" OnUploadComplete="AjaxFileUpload1_UploadComplete"
                    OnClientUploadComplete="onClientUploadComplete" MaximumNumberOfFiles="30" EnableViewState="true" />
            </div>
            ...
            <asp:SqlDataSource ID="SqlDataSourceTicketBrowse" runat="server" ConnectionString="<%$ ConnectionStrings:ServiceCubeConnectionString %>"
                SelectCommand="s_MyCreatedTicket" SelectCommandType="StoredProcedure"
                OnSelected="SqlDataSourceTicketBrowse_Selected">
                <SelectParameters>

                    <asp:ControlParameter Name="EmpID" Type="String" ControlID="txtEmployee" PropertyName="Text" DefaultValue="*" />
